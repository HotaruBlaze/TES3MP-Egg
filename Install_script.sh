...
cd /home/container
DOWNLOAD_URL=$(curl -sL https://api.github.com/repos/TES3MP/openmw-tes3mp/releases/tags/tes3mp-0.8.1 | jq -r ".assets[] | select(.name | contains(\"tes3mp-server-GNU+Linux-armv7l\")) | .browser_download_url")
